        ...
        <div className="flex-1 p-7 overflow-y-auto">
          ...
          <div className="rounded-[10px] bg-white/50 p-8 relative min-h-[850px]">
            ...
            <div className="grid grid-cols-3 gap-6 mt-20">
              ...
              <div className="rounded-[55px] border-[1.5px] border-black bg-gradient-to-r from-[#4F0A0A] to-[#780000] shadow-[0_14px_4px_0_rgba(0,0,0,0.50)]  h-auto p-6 flex flex-col items-center relative overflow-visible">
