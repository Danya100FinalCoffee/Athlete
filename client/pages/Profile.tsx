        ...
        <div className="w-[76px] border-r-2 border-[#5F5C5C] relative flex flex-col items-center pt-8 gap-12">
          ...
          <div className="space-y-8 flex flex-col items-center">
            ...
            <div className="relative">
              <div className="absolute left-0 top-0 w-[76px] h-[50px] bg-gradient-to-r from-[#4182F9]/50 to-[#4182F9]/0 mt-400 ml-0"></div>
              <svg
            ...
            {/* Analytics Icon */}
            <svg
              className="w-[21px] h-[20px] opacity-50 mt-4 ml-2"
              viewBox="0 0 21 20"
              fill="none"
              xmlns="http://www.w3.org/2000/svg"
            >
