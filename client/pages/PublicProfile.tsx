            ...
            <div className="col-span-5 space-y-6">
              ...
              <div className="flex items-center relative">
                <div className="relative z-10">
                  ...
                  />
                  <div
                    className="absolute top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2 text-[48px] font-medium -rotate-[15deg] text-center mt-8 ml-3"
                    style={{
              ...
              <div className="flex items-center relative">
                <div className="relative z-10">
                  ...
                  />
                  <div
                    className="absolute top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2 text-[48px] font-bold -rotate-[15deg] text-center mt-8 ml-3"
                    style={{
